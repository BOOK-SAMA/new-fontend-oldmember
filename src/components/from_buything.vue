                    ...
                    <div class="card-body">
                        <div class="row align-items-center pt-4 pb-3">
                            <div class="col-md-3 ps-5">
                                <h6 class="mb-0">หมายเลขคำสั่ง<span class="text-danger fw-bold">*</span></h6>
                            </div>
                            <div class="col-md-9 pe-5">
                                <span v-if="v$.uniqueorder.$error" class="text-danger fw-bold">
                                    {{ v$.uniqueorder.$errors[0].$message }}
                                </span>
                                <input type="text" class="form-control form-control-lg " v-model="state.uniqueorder" />
                            </div>
                        </div>

                        <div class="row align-items-center pt-4 pb-3">
                            <div class="col-md-3 ps-5">
                                <h6 class="mb-0">ชื่อภาษาไทยที่ได้ลงทะเบียนไว้ <span
        ...
        const rules = computed(() => {
            ...
            return {
                uniqueorder: {
                    ...
                    required: helpers.withMessage('กรุณาใส่ข้อมูล หมายเลขคำสั่งซื้อของคุณ', required),
            ...
            if (this.v$.$error) {
                ...
                axios.post(URL).then((response) => {
                    if (response.status === 200) {
                        const URL = `${import.meta.env.VITE_API2}fromforbuything`;
                        let data = new FormData();
                        data.append("uniqueorder", this.state.uniqueorder);
