<template>
	<!-- <div class="contrainer" style="padding: 1.5cm;">
		<div class="row ">
			<div class="row">
				<nav class="navbar navbar-expand navbar-dark fixed-top" style=" background-color: #F9CC02;">
					<ul class="navbar-nav mr-auto p-2">
						<li class="nav-item active mr-4">
							<a class="btn bg-dark  text-dark" data-toggle="collapse" href="#collapseExample"
								role="button">
								<span class="navbar-toggler-icon"></span
							</a>
						</li>
						<li class="nav-item active">
							<a class="nav-link text-dark" href="https://mytestsilpakorn.azurewebsites.net/">หน้าแรก</a>
						</li>
...
.profile-card {
  ...
  height: 400px; /* ตั้งค่าความยาวให้เท่ากับความกว้าง */
  background-color: #e7f2fe; /* สีพื้นหลัง */
  border-radius: 10px; /* ขอบมน */
  display: flex; /* ทำให้สามารถใช้ justify-content และ align-items ได้ */
  justify-content: center; /* จัดกึ่งกลางในแนวนอน */
  align-items: center; /* จัดกึ่งกลางในแนวตั้ง */
  box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* เงา */
  margin: 50px; /* ระยะห่างจากองค์ประกอบอื่น */
}
</style>
